...
import { BarChart2, Camera, ShieldCheck, ArrowRight, Zap, Target, Droplets, Trophy, Users, Flame, Timer, TrendingUp, ChevronRight, Star, Award, CheckCircle2, Wifi, BatteryFull, Activity, Plus, Dumbbell, Bell } from 'lucide-react';
import './Landing.css';
        ...
        <div className="lp-v5">
            ...
            <nav className="lp-v5-nav">
                <div className="lp-v5-nav-inner">
                    <div className="lp-v5-logo" onClick={() => { localStorage.setItem('ajwaa_last_view', 'saeed'); window.location.href = '/saeed'; }}>AJWAA</div>
